...
#include <limits>
namespace lve {
	void LveCamera::setOrthographicsProjection(float left, float right, float top, float bottom, float near, float far) {
	...
	void LveCamera::setPrespectiveProjection(float fovy, float aspect, float near, float far)
	{
